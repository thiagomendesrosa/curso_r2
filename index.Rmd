...
```{r}
dom2018_31ras <- read.csv2("F:/OneDrive/Doutorado/Monitoria FGV/curso_r2/dados/dom2018_31ras.csv")
```
...
```{r}
pdad_2018_moradores <- read_delim("http://www.codeplan.df.gov.br/wp-content/uploads/2020/06/dom2018_31ras.csv", 
